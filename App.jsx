...
.toast{background:var(--ink);color:white;padding:11px 18px;border-radius:var(--r);font-size:13px;font-weight:600;box-shadow:var(--sh2);animation:tIn .3s cubic-bezier(.34,1.56,.64,1);max-width:290px;border-left:4px solid var(--lime2);}
...
.land-logo sup{font-size:10px;background:var(--lime);color:var(--g1);border-radius:5px;padding:1px 5px;font-family:var(--fb);font-weight:900;margin-left:2px;}
.nav-btns{display:flex;gap:10px;align-items:center;}
.btn-ghost{padding:9px 20px;border-radius:var(--r);border:1.5px solid rgba(74,222,128,.3);background:transparent;color:var(--lime);font-family:var(--fb);font-size:13px;font-weight:600;cursor:pointer;transition:all .17s;}
.btn-ghost:hover{background:rgba(74,222,128,.1);}
.btn-lime{padding:9px 20px;border-radius:var(--r);border:none;background:var(--lime);color:var(--g1);font-family:var(--fb);font-size:13px;font-weight:800;cursor:pointer;transition:all .17s;}
.btn-lime:hover{background:#6ef99a;}
.dev-access-btn{padding:7px 16px;border-radius:var(--r);border:1px solid rgba(245,158,11,.3);background:rgba(245,158,11,.07);color:var(--amber);font-family:var(--fb);font-size:12px;font-weight:700;cursor:pointer;transition:all .17s;display:flex;align-items:center;gap:5px;}
...
.l-eyebrow{display:inline-flex;align-items:center;gap:8px;background:rgba(74,222,128,.1);border:1px solid rgba(74,222,128,.2);border-radius:30px;padding:8px 20px;color:var(--lime);font-size:13px;font-weight:700;margin-bottom:28px;}
...
.lst-l{font-size:13px;color:rgba(255,255,255,.42);font-weight:500;margin-top:4px;}
...
.rc-desc{font-size:13px;color:rgba(255,255,255,.5);line-height:1.7;}
.rc-link{display:inline-flex;align-items:center;gap:6px;margin-top:14px;font-size:13px;font-weight:700;}
.l-how{padding:88px 40px;background:var(--cream);}
.how-inner{max-width:960px;margin:0 auto;}
.l-lbl{font-size:11px;font-weight:800;text-transform:uppercase;letter-spacing:2px;color:var(--lime3);margin-bottom:10px;}
...
.hw-d{font-size:13px;color:var(--muted);line-height:1.65;}
...
.rpill{padding:9px 18px;border-radius:30px;background:rgba(74,222,128,.08);border:1px solid rgba(74,222,128,.17);color:var(--lime);font-size:13px;font-weight:600;}
.land-footer{padding:28px;text-align:center;color:rgba(255,255,255,.22);font-size:13px;border-top:1px solid rgba(255,255,255,.06);}
...
.ro-lab{font-size:12px;font-weight:700;}
.ro-sub{font-size:10px;color:var(--muted);margin-top:1px;}
.fgrp{margin-bottom:12px;}
.fgrp label{display:block;font-size:10px;font-weight:800;color:var(--muted);text-transform:uppercase;letter-spacing:.6px;margin-bottom:5px;}
.finp{width:100%;padding:11px 13px;border-radius:var(--r);border:1.5px solid var(--border);background:var(--cream);font-family:var(--fb);font-size:14px;color:var(--ink);outline:none;transition:border-color .13s;}
...
.auth-hint{font-size:11px;color:var(--dim);margin-top:4px;}
.auth-err{background:rgba(239,68,68,.08);border:1px solid rgba(239,68,68,.2);border-radius:9px;padding:9px 13px;color:#dc2626;font-size:13px;margin-bottom:11px;}
.btn-auth{width:100%;padding:14px;border-radius:var(--r);border:none;background:var(--g1);color:white;font-family:var(--fb);font-size:14px;font-weight:700;cursor:pointer;transition:all .17s;margin-top:3px;}
...
.auth-sw button{border:none;background:none;color:var(--lime3);font-weight:700;cursor:pointer;font-size:13px;text-decoration:underline;}
...
.cat-mini-lab{font-size:10px;font-weight:700;line-height:1.3;}
...
.btn-upload-logo{display:inline-flex;align-items:center;gap:6px;padding:9px 16px;border-radius:var(--r);border:1.5px solid var(--g3);background:transparent;color:var(--g3);font-family:var(--fb);font-size:12px;font-weight:700;cursor:pointer;transition:all .13s;}
...
.tb-brand sup{font-size:10px;background:var(--lime);color:var(--g1);border-radius:5px;padding:1px 5px;font-family:var(--fb);font-weight:900;margin-left:2px;}
.tb-tabs{display:flex;gap:2px;}
.tb-tab{padding:7px 12px;border-radius:9px;border:none;background:transparent;color:var(--muted);font-family:var(--fb);font-size:12px;font-weight:600;cursor:pointer;transition:all .13s;display:flex;align-items:center;gap:4px;white-space:nowrap;}
...
.tb-badge{background:var(--coral);color:white;font-size:10px;font-weight:800;padding:1px 5px;border-radius:9px;}
.tb-right{display:flex;align-items:center;gap:8px;}
.user-chip{display:flex;align-items:center;gap:6px;padding:5px 10px;border-radius:30px;background:var(--cream2);font-size:12px;font-weight:600;}
.role-tag{font-size:10px;font-weight:800;padding:2px 7px;border-radius:8px;}
...
.btn-out{padding:6px 12px;border-radius:8px;border:1.5px solid var(--border);background:transparent;color:var(--muted);font-size:11px;font-weight:600;cursor:pointer;transition:all .13s;}
...
.dev-bar-label{font-size:11px;font-weight:800;color:rgba(245,158,11,.6);text-transform:uppercase;letter-spacing:.8px;}
.dev-role-btn{padding:6px 14px;border-radius:9px;border:1.5px solid rgba(255,255,255,.1);background:transparent;color:rgba(255,255,255,.5);font-family:var(--fb);font-size:12px;font-weight:700;cursor:pointer;transition:all .14s;display:flex;align-items:center;gap:5px;}
...
.dev-info{margin-left:auto;font-size:11px;color:rgba(255,255,255,.25);font-style:italic;}
...
.iup-txt{font-size:13px;font-weight:700;color:var(--muted);}
.iup-hint{font-size:11px;color:var(--dim);}
.img-uploading{display:flex;align-items:center;justify-content:center;gap:9px;height:80px;color:var(--muted);font-size:13px;font-weight:600;}
...
.ch-sub{color:rgba(255,255,255,.52);font-size:13px;margin-top:3px;}
.ch-region{display:flex;align-items:center;gap:9px;margin-top:12px;flex-wrap:wrap;}
.ch-region label{font-size:10px;color:rgba(255,255,255,.4);font-weight:800;text-transform:uppercase;}
.rsel{padding:7px 12px;border-radius:var(--r);border:1.5px solid rgba(74,222,128,.27);background:rgba(255,255,255,.08);color:var(--lime);font-family:var(--fb);font-size:12px;font-weight:600;outline:none;cursor:pointer;}
...
.sbox input{flex:1;padding:12px 0;border:none;background:transparent;font-family:var(--fb);font-size:14px;color:var(--ink);outline:none;}
...
.cpill{display:flex;align-items:center;gap:5px;padding:8px 15px;border-radius:30px;border:1.5px solid var(--border);background:white;color:var(--muted);font-size:12px;font-weight:600;cursor:pointer;white-space:nowrap;transition:all .13s;flex-shrink:0;}
...
.bc-reg{position:absolute;top:9px;right:9px;background:rgba(255,255,255,.92);border-radius:20px;padding:3px 9px;font-size:10px;font-weight:700;}
...
.bc-cat{font-size:11px;color:var(--muted);margin-bottom:8px;}
.bc-meta{display:flex;align-items:center;gap:9px;}
.bc-rating{font-size:12px;font-weight:700;color:var(--amber2);}
.bc-cnt{font-size:11px;color:var(--dim);}
.bc-items{margin-left:auto;font-size:12px;font-weight:700;color:var(--g3);}

/* BIZ DETAIL */
.bdp{max-width:860px;margin:0 auto;padding:20px 12px;}
.back-btn{display:inline-flex;align-items:center;gap:5px;padding:7px 12px;border-radius:var(--r);border:1.5px solid var(--border);background:transparent;color:var(--muted);font-size:12px;font-weight:600;cursor:pointer;margin-bottom:16px;transition:all .13s;}
...
.bdp-desc{color:rgba(255,255,255,.52);font-size:13px;margin-top:4px;}
.bdp-tags{display:flex;gap:7px;flex-wrap:wrap;margin-top:9px;}
.bdp-tag{padding:3px 11px;border-radius:20px;background:rgba(74,222,128,.13);color:var(--lime);font-size:11px;font-weight:700;}
...
.pi-name{font-weight:700;font-size:13px;margin-bottom:2px;}
.pi-cat{font-size:10px;color:var(--dim);margin-bottom:6px;}
.pi-desc{font-size:11px;color:var(--muted);margin-bottom:8px;line-height:1.5;}
...
.qnum{font-weight:800;font-size:14px;min-width:20px;text-align:center;}

/* CART */
.cart-fab{position:fixed;bottom:24px;right:24px;background:var(--g1);color:white;border-radius:50px;padding:13px 22px;display:flex;align-items:center;gap:10px;box-shadow:0 8px 28px rgba(26,61,43,.42);cursor:pointer;font-weight:700;font-size:14px;transition:transform .17s;z-index:50;}
.cart-fab:hover{transform:scale(1.04);}
.cart-cnt{background:var(--lime);color:var(--g1);width:22px;height:22px;border-radius:50%;display:flex;align-items:center;justify-content:center;font-size:11px;font-weight:900;}
...
.ctr-lab{font-size:13px;color:var(--muted);}
.ctr-amt{font-family:var(--ff);font-size:25px;font-weight:900;color:var(--amber2);}
.btn-place{width:100%;padding:14px;border-radius:var(--r);border:none;background:var(--g1);color:white;font-family:var(--fb);font-size:14px;font-weight:700;cursor:pointer;margin-top:12px;transition:all .16s;}
...
.rcpt-biz-sub{font-size:12px;color:rgba(255,255,255,.52);margin-top:3px;}
.rcpt-body{padding:24px;}
.rcpt-divider{border:none;border-top:2px dashed var(--border2);margin:16px 0;}
.rcpt-row{display:flex;justify-content:space-between;font-size:13px;margin-bottom:8px;}
...
.rcpt-item{display:flex;justify-content:space-between;font-size:12px;padding:4px 0;color:var(--muted);}
.rcpt-item strong{color:var(--ink);font-weight:600;}
.rcpt-actions{display:flex;gap:8px;margin-top:16px;}
.btn-print{flex:1;padding:12px;border-radius:var(--r);border:1.5px solid var(--g1);background:transparent;color:var(--g1);font-family:var(--fb);font-size:13px;font-weight:700;cursor:pointer;}
.btn-done{flex:2;padding:12px;border-radius:var(--r);border:none;background:var(--g1);color:white;font-family:var(--fb);font-size:13px;font-weight:700;cursor:pointer;}
@media print{
...
.or-biz{font-size:12px;color:var(--muted);margin-bottom:4px;}
.or-items{font-size:11px;color:var(--dim);margin-bottom:7px;}
...
.or-time{font-size:11px;color:var(--dim);}
...
.tst-dot{width:26px;height:26px;border-radius:50%;background:var(--border);display:flex;align-items:center;justify-content:center;font-size:11px;font-weight:700;color:var(--dim);}
...
.tst-lab{font-size:8px;font-weight:700;color:var(--dim);text-align:center;line-height:1.3;}
...
.bh-sub{color:rgba(255,255,255,.52);font-size:12px;margin-top:3px;}
...
.bhs-l{font-size:10px;color:rgba(255,255,255,.42);font-weight:700;text-transform:uppercase;}
.biz-tabs{display:flex;gap:3px;margin-bottom:18px;border-bottom:2px solid var(--border2);}
.biztab{padding:9px 16px;border:none;background:transparent;color:var(--muted);font-family:var(--fb);font-size:12px;font-weight:600;cursor:pointer;border-bottom:2px solid transparent;margin-bottom:-2px;transition:all .13s;}
...
.pm-name{font-weight:700;font-size:13px;margin-bottom:3px;}
.pm-price{font-family:var(--ff);font-size:16px;font-weight:700;color:var(--g1);margin-bottom:10px;}
.pm-acts{display:flex;gap:6px;}
.btn-sm{padding:5px 10px;border-radius:7px;border:none;font-size:11px;font-weight:700;cursor:pointer;transition:all .13s;font-family:var(--fb);}
...
.oc-time{font-size:10px;color:var(--dim);}
.oc-cust{display:flex;align-items:center;gap:8px;margin-bottom:8px;}
.oc-av{width:32px;height:32px;border-radius:50%;background:var(--cream2);display:flex;align-items:center;justify-content:center;font-size:13px;}
.oc-cname{font-weight:600;font-size:13px;}
.oc-caddr{font-size:11px;color:var(--muted);}
.oc-items{font-size:11px;color:var(--muted);margin-bottom:8px;}
.oc-rider{background:rgba(74,222,128,.1);border:1px solid rgba(74,222,128,.2);border-radius:7px;padding:6px 10px;font-size:11px;color:var(--lime3);margin-bottom:8px;font-weight:600;}
...
.act-btn{padding:6px 12px;border-radius:var(--r);border:none;font-size:11px;font-weight:700;cursor:pointer;transition:all .13s;font-family:var(--fb);}
...
.ro2-name{font-weight:700;font-size:13px;}
.ro2-det{font-size:11px;color:var(--muted);}
.ro2-rat{margin-left:auto;color:var(--amber2);font-weight:700;font-size:12px;}
.macts{display:flex;gap:8px;margin-top:16px;}
.mact-sec{flex:1;padding:10px;border-radius:var(--r);border:1.5px solid var(--border);background:transparent;font-family:var(--fb);font-size:12px;font-weight:700;cursor:pointer;color:var(--muted);}
.mact-pri{flex:2;padding:10px;border-radius:var(--r);border:none;background:var(--g1);color:white;font-family:var(--fb);font-size:12px;font-weight:800;cursor:pointer;}
...
.rh-name{font-weight:700;font-size:14px;}
.rh-det{font-size:11px;color:var(--muted);}
...
.avail-lbl{font-size:12px;font-weight:700;}
...
.rs-l{font-size:10px;color:var(--muted);font-weight:700;text-transform:uppercase;margin-top:2px;}
...
.jr-pt{font-size:12px;font-weight:600;}
.jr-line{flex:1;height:2px;background:linear-gradient(90deg,var(--g1),var(--amber));border-radius:2px;}
.jc-items{font-size:11px;color:var(--muted);margin-bottom:11px;}
.btn-accept{width:100%;padding:11px;border-radius:var(--r);border:none;background:var(--lime2);color:white;font-family:var(--fb);font-size:13px;font-weight:800;cursor:pointer;transition:all .13s;}
...
.pay-badge{padding:4px 10px;border-radius:20px;font-size:11px;font-weight:800;}
...
.btn-call{display:inline-flex;align-items:center;gap:5px;padding:8px 16px;border-radius:var(--r);border:none;background:#25d366;color:white;font-size:12px;font-weight:700;cursor:pointer;font-family:var(--fb);}
.btn-deliver{display:inline-flex;align-items:center;gap:5px;padding:8px 16px;border-radius:var(--r);border:none;background:var(--g1);color:white;font-size:12px;font-weight:700;cursor:pointer;font-family:var(--fb);}
.btn-directions{display:inline-flex;align-items:center;gap:5px;padding:8px 16px;border-radius:var(--r);border:none;background:rgba(59,158,255,.12);color:var(--blue);font-size:12px;font-weight:700;cursor:pointer;font-family:var(--fb);text-decoration:none;}
...
.adm-hero p{color:rgba(255,255,255,.4);font-size:13px;margin-top:3px;}
.adm-badge2{display:inline-flex;align-items:center;gap:5px;background:rgba(74,222,128,.08);border:1px solid rgba(74,222,128,.2);border-radius:20px;padding:4px 12px;color:var(--lime);font-size:11px;font-weight:700;margin-top:8px;}
.mrr-box{text-align:right;}
.mrr-lab{font-size:10px;color:rgba(255,255,255,.35);text-transform:uppercase;font-weight:700;}
.mrr-val{font-family:var(--ff);font-size:36px;font-weight:900;color:var(--amber);}
.mrr-sub{font-size:12px;color:var(--lime);font-weight:700;}
...
.as-l{font-size:10px;color:var(--muted);font-weight:700;text-transform:uppercase;letter-spacing:.4px;margin-top:3px;}
...
.adm-tab{padding:9px 16px;border:none;background:transparent;color:var(--muted);font-family:var(--fb);font-size:12px;font-weight:600;cursor:pointer;border-bottom:2px solid transparent;margin-bottom:-2px;transition:all .13s;}
...
.tbl-hd{display:grid;padding:10px 16px;border-bottom:1px solid var(--border2);font-size:10px;font-weight:800;color:var(--muted);text-transform:uppercase;letter-spacing:.4px;}
...
.plan-pill{padding:3px 9px;border-radius:20px;font-size:11px;font-weight:800;}
.sdot{width:7px;height:7px;border-radius:50%;}
.adm-act{padding:5px 10px;border-radius:7px;border:none;font-size:11px;font-weight:700;cursor:pointer;font-family:var(--fb);}
...
.sub-bname{font-weight:700;font-size:14px;}
.sub-meta{font-size:11px;color:var(--muted);margin-top:2px;}
.sub-plans{display:flex;gap:7px;flex-wrap:wrap;margin-bottom:10px;}
.sub-plan-btn{padding:7px 14px;border-radius:var(--r);border:2px solid;font-size:12px;font-weight:800;cursor:pointer;background:transparent;transition:all .13s;font-family:var(--fb);}
.btn-record-pay{padding:7px 14px;border-radius:var(--r);border:none;background:var(--g1);color:white;font-size:12px;font-weight:700;cursor:pointer;font-family:var(--fb);}
...
.rev-bl{font-size:10px;color:var(--muted);font-weight:600;}
.btn-onboard{display:flex;align-items:center;gap:5px;padding:8px 16px;border-radius:var(--r);border:none;background:var(--g1);color:white;font-family:var(--fb);font-size:12px;font-weight:700;cursor:pointer;}

/* SHARED */
.sbadge{padding:3px 10px;border-radius:20px;font-size:11px;font-weight:800;}
...
.bnav-btn{flex:1;max-width:150px;padding:6px 0;border:none;border-radius:9px;background:transparent;color:var(--muted);font-family:var(--fb);font-size:10px;font-weight:700;cursor:pointer;}
...
.gps-val{font-family:var(--ff);font-size:13px;font-weight:700;color:var(--g1);}
.btn-gps{display:inline-flex;align-items:center;gap:5px;padding:8px 14px;border-radius:var(--r);border:1.5px solid var(--g3);background:transparent;color:var(--g3);font-family:var(--fb);font-size:12px;font-weight:700;cursor:pointer;transition:all .14s;}
.btn-gps:hover{background:var(--g1);color:white;border-color:var(--g1);}
.btn-gps:disabled{opacity:.5;cursor:not-allowed;}

/* DISCOUNT BADGE */
.disc-badge{display:inline-flex;align-items:center;gap:3px;background:linear-gradient(135deg,#ef4444,#dc2626);color:white;font-size:10px;font-weight:900;padding:2px 8px;border-radius:20px;margin-bottom:5px;}
.disc-orig{font-size:11px;color:var(--dim);text-decoration:line-through;margin-right:5px;}
.disc-save{font-size:10px;color:#dc2626;font-weight:700;}
.pi-price-row{display:flex;align-items:center;gap:6px;flex-wrap:wrap;margin-bottom:11px;}
.pm-disc-badge{background:rgba(239,68,68,.12);color:var(--red);font-size:9px;font-weight:900;padding:1px 6px;border-radius:10px;}

/* SORT BAR */
.sort-bar{display:flex;align-items:center;gap:8px;margin-bottom:16px;flex-wrap:wrap;}
.sort-lbl{font-size:11px;font-weight:800;color:var(--muted);text-transform:uppercase;letter-spacing:.5px;white-space:nowrap;}
.sort-btn{padding:6px 12px;border-radius:20px;border:1.5px solid var(--border);background:white;color:var(--muted);font-size:11px;font-weight:600;cursor:pointer;transition:all .13s;white-space:nowrap;}
...
.town-opt{padding:9px 13px;font-size:13px;cursor:pointer;transition:background .1s;}
...
.rider-panel-title{font-size:11px;font-weight:800;color:var(--muted);text-transform:uppercase;letter-spacing:.5px;margin-bottom:10px;}
...
.rac-av{width:36px;height:36px;border-radius:50%;background:var(--g1);color:var(--lime);display:flex;align-items:center;justify-content:center;font-weight:900;font-size:14px;flex-shrink:0;}
.rac-name{font-weight:700;font-size:12px;}
.rac-det{font-size:10px;color:var(--muted);}
.rac-rat{margin-left:auto;color:var(--amber2);font-size:11px;font-weight:700;}

/* ADD TO CART BUTTON */
.btn-add-cart{width:100%;padding:9px;border-radius:var(--r);border:none;background:var(--g1);color:white;font-family:var(--fb);font-size:12px;font-weight:700;cursor:pointer;transition:all .15s;margin-top:8px;}
...
.qty-ctrl .qnum{color:white;font-weight:800;font-size:13px;}
...
.tmd-btn{padding:12px 16px;border-radius:var(--r);border:none;background:transparent;color:var(--ink);font-family:var(--fb);font-size:14px;font-weight:600;cursor:pointer;text-align:left;display:flex;align-items:center;gap:10px;}
...
.bbn-btn{flex:1;padding:6px 4px;border:none;border-radius:8px;background:transparent;color:var(--muted);font-family:var(--fb);font-size:9px;font-weight:700;cursor:pointer;display:flex;flex-direction:column;align-items:center;gap:2px;}
.bbn-btn .bbn-ico{font-size:18px;}
.bbn-btn.act{color:var(--g1);background:var(--cream);}
.bbn-badge{background:var(--coral);color:white;font-size:8px;font-weight:900;padding:1px 4px;border-radius:8px;min-width:14px;text-align:center;}
...
@media(max-width:700px){
  ...
  .cart-fab{bottom:72px;right:14px;padding:11px 16px;font-size:13px;}
...
.fleet-stat-lbl{font-size:9px;color:var(--muted);margin-top:2px;line-height:1.2;}
...
function BusinessApp({user, profile, toast}) {
  ...
  useEffect(()=>{ if(!user)return; return listenMyBusiness(user.uid,b=>{
  ...
  // profile.username comes from users collection on login
  const shopSlug = biz.ownerUsername || profile?.username || "";
  const shopUrl  = shopSlug ? `https://localbizgh.web.app/?shop=${shopSlug}` : "";
  // Self-heal: if biz.ownerUsername is missing, write it from profile.username
  useEffect(()=>{
    if(biz && !biz.ownerUsername && profile?.username){
      updateBusiness(biz.id,{ownerUsername:profile.username}).catch(()=>{});
    }
  },[biz?.id, biz?.ownerUsername, profile?.username]);
  ...
  return (
    <div className="bw">
      ...
      {newOrderAlerts.map(alert=>(
        ...
        {[["orders",`📋 Orders${pending>0?` (${pending})`:""}`],["fleet","🚗 My Fleet"],["dispatch","🚚 Dispatch"],["products","📦 Products"],["shop","🏪 Shop Profile"],["info","ℹ️ Info"]].map(([t,l])=>(
      ...
      <div className="biz-bot-nav">
        {[["orders","📋",`Orders${pending>0?` (${pending})`:""}`],["fleet","🚗","Fleet"],["dispatch","🚚","Dispatch"],["products","📦","Products"],["shop","🏪","Profile"],["info","ℹ️","Info"]].map(([t,ico,lab])=>(
...
export default function App() {
  ...
  const renderMain = () => {
    ...
    if(profile?.role==="business"&&tab==="store") return <BusinessApp user={fbUser} profile={profile} toast={toast}/>;
...
function AdminBizProxy({toast}) {
  ...
  return <BusinessApp user={mockUser} profile={mockProfile} toast={toast}/>;
}
